...
class EnumToEnumConverter : Converter<Enum<*>, Enum<*>>(Enum::class.java, Enum::class.java) {
    ...
    override fun toTheirs(value: Enum<*>?, registry: Registry, ourType: Class<out Enum<*>>, targetFormatType: Class<*>, field: Field?): Enum<*>? {
    ...
    override fun toOurs(value: Enum<*>?, registry: Registry, ourType: Class<out Enum<*>>, targetFormatType: Class<*>, field: Field?): Enum<*>? {
        if (value == null) return null
