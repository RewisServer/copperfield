...
class MapToProtoStructConverter : Converter<Map<*, *>, Struct>(Map::class.java, Struct::class.java) {
    ...
    override fun toTheirs(value: Map<*, *>?, agent: CopperfieldAgent, ourType: Class<out Map<*, *>>, targetFormat: Class<out Any>, field: Field?): Struct? {
    ...
    override fun toOurs(value: Struct?, agent: CopperfieldAgent, ourType: Class<out Map<*, *>>, targetFormat: Class<out Any>, field: Field?): Map<*, *>? {
